...
(function () {
	...
	var svgDrawer = (function() {
      ...
      const margin = 2;
			...
			svg.appendChild(makeSVG("rect", {width: nCount + 2*margin, height: nCount + 2*margin, x: -margin, y: -margin, "fill": _htOption.colorLight, "width": "100%", "height": "100%"}));
	...
	var useSVG = true;//document.documentElement.tagName.toLowerCase() === "svg";
	...
	var Drawing = useSVG ? svgDrawer : !_isSupportCanvas() ? (function () {
      ...
      _oContext.translate(2*nWidth,2*nHeight);
      _oContext.scale(nCount/(nCount+4), nCount/(nCount+4));
